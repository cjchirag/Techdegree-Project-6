...
class Vehicle {
    ...
    init(Name: String, Model: String, Manufacturer: String, Cost_In_Credits: String, Length: String, Max_Atmosphering_Speed: String, Crew: String, Passengers: String, Cargo_Capacity: String, Consumables: String, Vehicle_Class: String, Pilots: [String], Films: [String]){
        self.name = Name
        self.model = Model
...
extension Vehicle {
    convenience init?(json: [String:Any]) {
        ...
        let vehicle_class = json[key.vehicle_class] as? String,
        let pilots = json[key.pilots] as? [String],
        let films = json[key.films] as? [String]
            else { return nil }
        
        self.init(Name: name, Model: model, Manufacturer: manufacturer, Cost_In_Credits: cost_in_credits, Length: length, Max_Atmosphering_Speed: max_atmosphering_speed, Crew: crew, Passengers: passengers, Cargo_Capacity: cargo_capacity, Consumables: consumables, Vehicle_Class: vehicle_class, Pilots: pilots, Films: films)
